...
The `X-Source` header allows you to identify your domain when making requests to LLM API. This information is used to generate public usage statistics showing how LLM API is being used across different websites and applications.
...
Data from the `X-Source` header is used to generate public statistics about LLM API usage, including:

- **Popular Domains**: Which websites and applications are using LLM API most frequently
...
These statistics help demonstrate the adoption and impact of LLM API across the ecosystem.
...
- **Community**: Contributes to the broader LLM API ecosystem
...
- Support transparency in the LLM API ecosystem
