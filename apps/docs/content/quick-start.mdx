...
> **TL;DR** — Point your HTTP requests to `https://api.llmapi.ai/v1/…`, supply your `LLM_API_KEY`, and you’re done.
...
>
  <Tab value="cURL">
    <DynamicCodeBlock lang="bash" code={`curl -X POST https://api.llmapi.ai/v1/chat/completions \\
  ...
  <Tab value="TypeScript">
    <DynamicCodeBlock lang="typescript" code={`const response = await fetch('https://api.llmapi.ai/v1/chat/completions', {
  method: 'POST',
  headers: {
...
.uri(URI.create("https://api.llmapi.ai/v1/chat/completions"))
...
apiKey := os.Getenv("LLM_API_KEY")
    ...
    req, _ := http.NewRequest("POST", "https://api.llmapi.ai/v1/chat/completions", bytes.NewBuffer(jsonData))
...
uri = URI('https://api.llmapi.ai/v1/chat/completions')
