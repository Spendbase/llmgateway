...
description: Connect AWS Bedrock to LLM API for access to foundation models
icon: Cloud
---

import { Step, Steps } from "fumadocs-ui/components/steps";

AWS Bedrock is Amazon's fully managed service that provides access to foundation models from leading AI companies. This guide shows how to create AWS Bedrock Long-Term API Keys and integrate them with LLM API.
...
Once configured, you can access all AWS Bedrock models through LLM API:
...
Browse all available models at [llmapi.ai/models](https://llmapi.ai/models?provider=aws-bedrock)
