---
title: Rate Limits
description: Understanding rate limits for free and paid models on LLM API.
icon: Timer
---
...
LLM API implements rate limits to ensure fair usage and optimal performance for all users. The rate limits differ based on your account status and the type of models you're using.
