...
2. Enter the following details:
   ...
   - **Model ID**: Choose a model (e.g., `claude-opus-4-6`, `claude-opus-4-5-20251101`, `gpt-5.2`, `gemini-3-pro-preview`, `deepseek-3.2`). See [provider-specific routing](/features/routing#provider-specific-routing) for more options.
