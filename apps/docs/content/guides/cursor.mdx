...
1. Log in to your [LLM Gateway dashboard](https://llmapi.ai/dashboard)
...
8. Enter the LLM Gateway endpoint: `https://api.llmapi.ai/v1`
...
2. Choose any [LLM Gateway supported model](https://llmapi.ai/models):
