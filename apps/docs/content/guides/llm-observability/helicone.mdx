...
description: Connect Helicone to LLM API for AI-powered capabilities
icon: Helicone
---
...
1. Configure your application to route through Helicone to LLM API:
...
2. All requests will be logged in Helicone and forwarded to LLM API.

```yaml
Tip: Helicone adds observability (logging, latency tracking, cost analysis) on top of LLM API.
```
