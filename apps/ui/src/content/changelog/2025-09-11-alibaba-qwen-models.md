...
image:
  ...
  alt: "Alibaba Qwen models now available on LLM API"
  width: 1768
  height: 677
---
...
- Capabilities: Streaming, Tools, JSON output
  [Try in Chat Playground](https://chat.llmapi.ai/?model=alibaba/qwen3-next-80b-a3b-instruct)
...
- Capabilities: Streaming, Reasoning, Tools, JSON output
  [Try in Chat Playground](https://chat.llmapi.ai/?model=alibaba/qwen3-next-80b-a3b-thinking)
...
- Capabilities: Streaming, Vision, Tools, JSON output
  [Try in Chat Playground](https://chat.llmapi.ai/?model=alibaba/qwen-max)
...
- Context: 131,072 tokens, Max output: 32,000 tokens
- Capabilities: Streaming, Vision, Tools, JSON output
  [Try in Chat Playground](https://chat.llmapi.ai/?model=alibaba/qwen-max-latest)
...
- Capabilities: Streaming, Tools, JSON output
  [Try in Chat Playground](https://chat.llmapi.ai/?model=alibaba/qwen-plus-latest)
...
- Context: 1,000,000 tokens, Max output: 32,000 tokens
- Capabilities: Streaming, Tools, JSON output
  [Try in Chat Playground](https://chat.llmapi.ai/?model=alibaba/qwen-flash)
...
- Capabilities: Streaming, Vision, JSON output
  [Try in Chat Playground](https://chat.llmapi.ai/?model=alibaba/qwen-vl-max)
...
- Context: 131,072 tokens, Max output: 32,000 tokens
- Capabilities: Streaming, Vision, JSON output
  [Try in Chat Playground](https://chat.llmapi.ai/?model=alibaba/qwen-vl-plus)
