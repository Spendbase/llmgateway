...
export function getResetPasswordEmail({
	...
	const content = `
		<h1 style="color: #3F35FF; margin-top: 0;">Reset Password</h1>
		<p style="font-size: 16px; margin-bottom: 20px;">
			You requested to reset your password. Click the link below to proceed:
		</p>
		<div style="text-align: center; margin: 30px 0;">
			<a href="${url}" style="display: inline-block; background-color: #3F35FF; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: 500;">Reset Password</a>
		</div>
