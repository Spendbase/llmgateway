...
export const openaiModels = [
	...
	},
	{
		...
		name: "GPT-5 Codex",
		description:
			"GPT-5 specialized for code generation and software development tasks.",
		family: "openai",
		releasedAt: new Date("2025-08-01"),
		providers: [
			{
	...
	},
	{
		...
		name: "GPT-5.2 Codex",
		description:
			"GPT-5.2 optimized for long-horizon, agentic coding tasks in Codex or similar environments.",
		family: "openai",
		releasedAt: new Date("2025-12-11"),
		providers: [
			{
	...
	},
	{
		...
		name: "GPT-5.3 Codex",
		description:
			"The most capable agentic coding model, optimized for long-horizon coding tasks in Codex or similar environments.",
		family: "openai",
	...
	},
	{
		...
		name: "GPT-5.3 Chat",
		description:
			"GPT-5.3 Instant model used in ChatGPT, optimized for conversational interactions.",
		family: "openai",
		releasedAt: new Date("2026-03-03"),
		providers: [
			{
	...
	},
	{
		...
		name: "GPT-5.4",
		description:
			"Most capable OpenAI model for professional work with enhanced reasoning, vision, and web search.",
		family: "openai",
	...
	},
	{
		...
		name: "GPT-5.4 Pro",
		description:
			"Premium GPT-5.4 tier with more compute for smarter, more precise responses on complex professional tasks.",
		family: "openai",
		releasedAt: new Date("2026-03-05"),
		providers: [
			{
