...
ALTER TABLE "api_key" ADD COLUMN "last_reset_at" timestamptz;--> statement-breakpoint
ALTER TABLE "api_key" ADD COLUMN "next_reset_at" timestamptz;--> statement-breakpoint
ALTER TABLE "api_key" ADD COLUMN "expires_at" timestamptz;--> statement-breakpoint
